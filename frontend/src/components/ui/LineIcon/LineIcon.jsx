...
const ICONS = {
  whatsapp: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.116 1.523 5.847L.057 23.535a.75.75 0 0 0 .916.932l5.824-1.53A11.945 11.945 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.715 9.715 0 0 1-4.953-1.355l-.355-.211-3.656.961.976-3.563-.232-.366A9.712 9.712 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
    </svg>
  ),
  mail: (
...
export const LineIcon = ({ name = 'document', className = '', 'aria-label': ariaLabel }) => (
  <span
    className={`disnal-line-icon ${className}`.trim()}
