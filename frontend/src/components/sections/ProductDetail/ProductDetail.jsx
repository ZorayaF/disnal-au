...
/* Ícono genérico por nombre de atributo */
...
export const ProductDetail = ({ producto }) => {
  ...
  if (!producto) return <p style={{ padding: 20 }}>No hay información del producto.</p>;
  ...
  const tieneSpecs  = producto?.detallesTecnicos && Object.keys(producto.detallesTecnicos).length > 0;
    ...
    <div className="pd">
      <div className="pd__body">
        ...
        <div className="pd__gallery">
          ...
          {/* Si solo hay 1 imagen mostramos igual la miniatura activa */}
          {imagenes.length === 1 && (
            <div className="pd__thumbnails">
        ...
        <div className="pd__info">
          ...
          {/* Meta rows + stock widget lado a lado */}
          <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start', marginBottom: 20 }}>
            <div className="pd__meta" style={{ flex: 1 }}>
              {/* Estado */}
              <div className="pd__meta-row">
                <svg className="pd__meta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/>
                  <path d="m9 12 2 2 4-4"/>
                </svg>
                <span className="pd__meta-label">Estado:</span>
                <span className={`pd__meta-value ${disponible ? 'pd__meta-value--disponible' : 'pd__meta-value--nodisp'}`}>
              ...
              <div className="pd__meta-row">
                ...
                <span className="pd__meta-value">{producto.cantidad} unidades</span>
              </div>
              {/* Categoría */}
              <div className="pd__meta-row">
                <svg className="pd__meta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="pd__stock-widget">
              <svg className="pd__stock-widget-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                <path d="M6 3h12l2 6H4l2-6z"/>
                <path d="M4 9c0 7 2 12 8 12s8-5 8-12"/>
              </svg>
              <div className="pd__stock-widget-body">
                <span className="pd__stock-widget-num">{producto.cantidad}</span>
                <span className="pd__stock-widget-unit">Unidades</span>
                <span className="pd__stock-widget-sub">En stock</span>
              </div>
            </div>
          </div>
          ...
          <div className="pd__specs">
            ...
            {tieneSpecs ? (
              ...
              <p className="pd__specs-empty">No registradas para este lote comercial.</p>
            )}
          </div>
          ...
          {cantidadActual > 0 && (
            <div className="pd__cart-alert">
              ...
              Tienes <strong>&nbsp;{cantidadActual} unidades&nbsp;</strong> agregadas al carrito.
            </div>
          )}
          ...
          <p className="pd__presentacion">
            ...
            <span>{producto.presentacion || 'Empaque original de fábrica'}</span>
          </p>
