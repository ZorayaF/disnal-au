      ...
      <div className="cart-panel">
        ...
        {!sincronizando && (
          <div className="cart-panel__header">
            <div>
              <p className="cart-panel__step-label">Paso {step} de 4</p>
                  ...
                  <div className="shipping-field">
                    ...
                    >
                      <option value="Gestionado por Distribuidora">
                        Envío Gestionado por Distribuidora (Requiere cotizar
                        flete)
                      </option>
                      <option value="Contraentrega">
                        Flete Contraentrega (Pagas a la transportadora al
                        recibir)
                      </option>
                    ...
                    <div className="shipping-row">
                      ...
                      <div className="shipping-field">
                        ...
                        <div className="shipping-field__input-wrap">
                          <svg
                            className="shipping-field__input-icon"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
              ...
              {step === 3 && (
                <div className="review-step">
                  ...
                  <div className="review-summary">
                    <h4 className="review-summary__title">
              ...
              {step === 4 && (
                <div className="confirm-step">
                  ...
                  <p className="confirm-step__desc">
                    ...
                    administrador revisará las existencias, asignará el costo
                    del flete de ser necesario y se te notificará vía correo
