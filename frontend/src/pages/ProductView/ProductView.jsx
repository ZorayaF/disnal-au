...
export const ProductView = () => {
  ...
  // 3. Extraemos el estado reactivo de autenticación del contexto global
  ...
  return (
    <div className="product-view">
      <div className="product-view__inner">
        ...
        {/* ── Ficha del producto ── */}
        {/* 4. Le inyectamos 'isAuthenticated' a la sección para que controle la visualización de stock y cotizaciones */}
        <ProductDetail producto={producto} isAuthenticated={isAuthenticated} />

        {/* ── Productos relacionados ── */}
        {productosRelacionados.length > 0 && (
          <section className="product-view__related">
            <h2 className="product-view__related-title">
              Productos Relacionados
            </h2>
